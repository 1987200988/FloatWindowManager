...
//    public static final String NIGHTMODE_MSG = "6";
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            MessageData messageData = listTemp.pop();
            if(messageData!=null){
                list.remove(messageData);
                Log.e(TAG, "handleMessage: 我是空的" );
...
//        LinearLayout connectionInfoLL = FloatWindow.get(LEFT_BOTTOM).getView().findViewById(R.id.connectionInfoLL);
//        if (connectionFlag) {
//            connectionFlag = false;
